'''
This implementation is modified from the implementation of the authour of the original paper.
'''
...
def ring_signature_gen(siging_key, key_idx, M, y, G=SECP256k1.generator, hash_func=hashlib.sha3_256):
    """
